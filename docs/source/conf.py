...
Notes:
    ...
    cd ~/code/mathutf/docs
    sphinx-apidoc --private -f -o ~/code/mathutf/docs/source ~/code/mathutf/mathutf --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/mathutf/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: mathutf
            Set the Repository URL: https://github.com/Erotemic/mathutf

        For gitlab you also need to setup an integrations and add gitlab
        incoming webhook

            https://readthedocs.org/dashboard/mathutf/integrations/create/

        Then go to

            https://github.com/Erotemic/mathutf/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/mathutf/versions/
"""
#
...
# html_logo = '.static/mathutf.svg'
# html_favicon = '.static/mathutf.ico'
...
latex_documents = [
    (master_doc, 'mathutf.tex', 'mathutf Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'mathutf', 'mathutf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mathutf', 'mathutf Documentation',
     author, 'mathutf', 'One line description of project.',
     'Miscellaneous'),
]
